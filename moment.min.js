!(function (e, t) {
   ...
   function e(r, a) {
      ...
      return E(function () {
         if (
            (null != f.deprecationHandler && f.deprecationHandler(null, r), o)
         ) {
   ...
   s("H", ["HH", 2], 0, "hour"),
      ...
      s("hmmss", 0, 0, function () {
         return (
            "" + st.apply(this) + r(this.minutes(), 2) + r(this.seconds(), 2)
         );
      }),
      s("Hmm", 0, 0, function () {
              ...
              : ((e._a = t),
                (e._tzm =
                   ...
                   n
                      ...
                      : s
                      ? 0
                      : 60 * (((n = parseInt(i, 10)) - (s = n % 100)) / 100) +
                        s)),
         ...
         !(function (e) {
            ...
            for (i = 0; i < u; i++)
               (r = 0),
                  ...
                  A(t) && (a = !0),
                  (r =
                     (r += m(t).charsLeftOver) + 10 * m(t).unusedTokens.length),
                  (m(t).score = r),
                  o
                     ? r < s && ((s = r), (n = t))
                     : (null == s || r < s || a) &&
   ...
   return (
      ...
      (U.as = function (e) {
         ...
         if ("month" === (e = _(e)) || "quarter" === e || "year" === e)
            switch (
               ((t = this._days + s / 864e5), (n = this._months + wn(t)), e)
            ) {
               case "month":
                  return n;
               case "quarter":
